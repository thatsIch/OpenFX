...
public class TestSmallMultiLayerPerceptron
{
	...
	public void testOutput()
	{
		...
		try
		{
			...
			DoubleMatrix[] matrices = {
				new DenseDoubleMatrix( matrix01 ),
				new DenseDoubleMatrix( matrix12 ),
	...
	public void testTrainWithSquaredError()
	{
		...
		SmallMultiLayerPerceptron mlp = new SmallMultiLayerPerceptron( learningRate, regularization, momentum, squashingFunctionName, costFunctionName, layerSizeArray );
	...
	public void testTrainingByXOR()
	{
		...
		try
		{
			...
			if ( !fs.exists( dataPath ) )
			{
				...
				SequenceFile.Writer writer = new SequenceFile.Writer( fs, conf, dataPath, LongWritable.class, VectorWritable.class );
