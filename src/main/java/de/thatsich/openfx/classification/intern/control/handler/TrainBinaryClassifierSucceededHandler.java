 ...
 * @author Minh
 */
public class TrainBinaryClassifierSucceededHandler extends ACommandHandler<ITraindBinaryClassifier>
{
	@Inject private IBinaryClassifications binaryClassifications;

	@Override
	public void handle(ITraindBinaryClassifier classification)
	{
