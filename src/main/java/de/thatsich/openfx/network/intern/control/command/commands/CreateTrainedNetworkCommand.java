...
public class CreateTrainedNetworkCommand extends ACommand<ITrainedNetwork>
{
	...
	@Inject
	public CreateTrainedNetworkCommand(@Assisted List<IImage> images, @Assisted List<IErrorGenerator> errorGenerators, @Assisted List<IFeatureExtractor> featureExtractors, @Assisted List<IPreProcessor> preProcessors, @Assisted List<IBinaryClassifier> binaryClassifiers, ErrorFileStorageService errorStorage, TrainedPreProcessorFileStorageService preProcessorFileStorageService, NetworkFileStorageService networkStorage, Log log)
	{
		this.images = images;
	...
	{
		final INetworkSpace networkSpace = new NetworkSpace();
		this.log.info("Created NetworkSpace.");

		final ITrainedNetwork trainedNetwork = networkSpace.train(this.images, this.errorGenerators, this.errorStorage, this.featureExtractors, this.preProcessors, this.preProcessorFileStorageService, this.binaryClassifiers);
