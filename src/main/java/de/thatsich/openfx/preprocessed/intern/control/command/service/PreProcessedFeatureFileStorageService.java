package de.thatsich.openfx.preprocessed.intern.control.command.service;
 ...
 * @since 06.06.2014.
 */
public class PreProcessedFeatureFileStorageService extends AFileStorageService<IFeature>
{
	@Inject
	protected PreProcessedFeatureFileStorageService(final IPreProcessedState state)
	{
