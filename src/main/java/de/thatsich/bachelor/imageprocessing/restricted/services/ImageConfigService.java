...
public class ImageConfigService extends AConfigurationService {
	...
	// Getter
	public String getLastLocationString() { return super.get(LAST_LOCATION, DEFAULT_LAST_LOCATION); }
	public int getLastImageIndexInt() { return super.get(LAST_IMAGE_INDEX, DEFAULT_LAST_IMAGE_INDEX); }
	
	// Setter
	public void setLastLocationString(String lastLocation) { super.set(LAST_LOCATION, lastLocation); }
